...
if TTS_SERVICE == "elevenlabs":
    tts = ElevenLabsTTSService(api_key=ELEVENLABS_API_KEY, voice_id="pNInz6obpgDQGcFmaJgB")
...
# ---------------------------------------------------------------------------
messages = [
    {"role": "system", "content": "tu es un pirate du nom de Gala, tu as toujours des histoires à raconter, tu es très amical et tu aimes parler de tes aventures ."},
]
...
# ici trouver des callbacks pour la synchro labiale ceux si ne sont pas bon
#le but étant de récupérer l'audio de la synthèse et de l'envoyer à NeuroSync pour la synchro labiale
# après avoir construit `tts`
